...
export default async function DetailAnime({ params }) {
  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        <div className="flex gap-x-3 w-[100%] lg:w-[80%] mx-auto">
          <div className="flex-1">
            {dataAnime.trailer.images.maximum_image_url ? (
              <Image className="rounded-md h-full" src={dataAnime.trailer.images.maximum_image_url} alt="Anime" width={700} height={700} />
            ) : (
              <Image className="rounded-md h-[450px] w-full" src={dataAnime.images.jpg.large_image_url} alt="Anime" width={280} height={280} />
            )}
          </div>
      ...
      <div className="flex justify-center gap-x-5 py-5 px-3 mt-3 text-zinc-300 w-fit mx-auto border-amber-500 border-2">
